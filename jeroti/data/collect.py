...
def collect_and_save(duration=15, interval=1):
    ...
    # Default JSON output is inside this project. You can override via env var JEROTI_JSON_DIR.
    json_dir = os.environ.get("JEROTI_JSON_DIR", "data")
    json_path = os.path.join(json_dir, f"{duration}seconds-{date}.json")
