...
import time
import pandas as pd
from runner import run_detection_with_saved_model
from data.collect import collect_and_save
from train import train_model
from realtime import (
    start_realtime_learning_and_detection,
    stop_all,
    is_running,
)
...
def main():
    while True:
        try:
            ...
            # Ctrl+C should stop running detections, not exit the CLI.
            if is_running():
                stop_all()
                print("\nReal-time learning & detection stopped.")
